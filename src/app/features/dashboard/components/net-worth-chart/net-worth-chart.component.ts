import { Component, input, viewChild, ElementRef, afterNextRender, afterRender, OnDestroy } from '@angular/core';
...
@Component({
  ...
  template: `
    <div class="rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
      <h2 class="mb-4 text-base font-semibold text-gray-900">Evolución Patrimonio Neto</h2>
